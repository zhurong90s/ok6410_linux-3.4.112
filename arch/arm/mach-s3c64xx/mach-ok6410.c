...
static void __init ok6410_machine_init(void)
{
	...
	s3c_nand_set_platdata(&ok6410_nand_info);//复制ok6410_nand_info的所有数据，到新申请的内存空间，包含所有指针区域，
											 //使得platform_device->dev.platform_data=ok6410_nand_info的复制品i
											 //这里platform_device是s3c_devic_nand变量
